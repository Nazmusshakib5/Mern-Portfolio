            ...
            <div id='contact' className='pt-24 CustomBgFour pb-16 md:w-5/6 md:mx-auto'>
                ...
                <div className='md:px-[5rem] px-[2rem] grid md:grid-cols-5 grid-cols-1 mx-auto'>
                    <div className='w-full col-span-2 '>
                        ...
                        <p className='text-amber-50 mt-3 pe-2 md:pe-12'>Feel free to get in touch with me. I am always
                            open
                    ...
                    <div
                        className='w-full col-span-3 md:grid grid-cols-12 md:gap-5 flex flex-col gap-3 text-amber-50 mt-6 md:mt-0'>
